...
void FrmKanalProdajeKorisnik::on_btnPotvrda_clicked()
{
    ...
    g_FILTER_KORISNIK_ID = g_UNIO_KORISNIK_ID;
    g_FILTER_KORISNIK_NAZ = g_UNIO_KORISNIK_NAZ;
    g_FILTER_KORISNIK_IME = g_UNIO_KORISNIK_IME;
    g_FILTER_ORGJED_ID = g_UNIO_ORGJED_ID;
    g_FILTER_ORGJED_NAZ = g_UNIO_ORGJED_NAZ;
    g_FILTER_KANAL_ID = g_UNIO_KANAL_ID;
    g_FILTER_KANAL_NAZ = g_UNIO_KANAL_NAZ;
    g_FILTER_REGIJA_ID = g_UNIO_REGIJA_ID;
    g_FILTER_REGIJA_NAZ = g_UNIO_REGIJA_NAZ;
    g_FILTER_ZUPANIJA_ID = g_UNIO_ZUPANIJA_ID;
    g_FILTER_ZUPANIJA_NAZ = g_UNIO_ZUPANIJA_NAZ;
